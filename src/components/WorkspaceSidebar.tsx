        ...
        {activeTool === 'workspaces' ? (
          <div className="space-y-2">
            {workspaces.map((workspace) => {
              ...
              return (
                <button
                  ...
                  className={`flex min-h-8 w-full items-center justify-between gap-2 rounded-full border px-3 py-1.5 text-left transition ${
                    isCurrent
                      ...
                      : 'border-[var(--sidebar-stroke)] bg-[var(--sidebar-hover)] hover:bg-white/15'
                  }`}
                ...
                >
                  ...
                  {isCurrent && (
                    <span className="shrink-0 rounded-full bg-white/15 px-2 py-0.5 text-[10px] font-semibold text-[var(--sidebar-active-text)]">
                      Current
                    </span>
                  )}
                </button>
            ...
            {isAddingWorkspace ? (
              <form
                ...
                className="flex min-h-8 w-full items-center gap-2 rounded-full border border-dashed border-white/25 bg-[var(--sidebar-hover)] px-3 py-1.5"
              >
                <input
              ...
              <button
                ...
                className="flex min-h-8 w-full items-center justify-between rounded-full border border-dashed border-white/20 bg-transparent px-3 py-1.5 text-left text-xs font-semibold text-[var(--sidebar-muted)] transition hover:border-white/40 hover:text-[var(--sidebar-text)]"
                title="Add workspace"
              >
            ...
            {sections.map((section) => {
              ...
              return (
                <div
                  ...
                  className="group relative flex min-h-8 items-center gap-2 rounded-full border border-[var(--sidebar-stroke)] bg-[var(--sidebar-hover)] px-3 py-1.5 transition hover:bg-white/15"
                >
                  <div className="min-w-0 flex-1">
                    {isEditing ? (
                      <input
                        ...
                        className="h-6 w-full rounded-md border border-white/25 bg-white/10 px-2 text-xs font-normal text-[var(--sidebar-text)] outline-none transition focus:border-[var(--sidebar-active-text)] focus:ring-2 focus:ring-white/10"
                        autoFocus
                      />
                    ) : (
                      <button
                        ...
                        className="block max-w-full truncate text-left text-xs font-semibold text-[var(--sidebar-text)]"
                  ...
                  <span className="shrink-0 rounded-full bg-white/15 px-2 py-0.5 text-[10px] font-semibold text-[var(--sidebar-muted)]">
                    {sectionTaskCount}
                  </span>
                  ...
                  <button
                    ...
                    className={`h-6 w-6 shrink-0 items-center justify-center rounded-full text-sm text-[var(--sidebar-faint)] transition hover:bg-white/15 hover:text-[#ff6b61] disabled:cursor-not-allowed disabled:opacity-30 ${
          ...
          <div className="space-y-2">
            ...
            {activityLogs.length > 0 ? (
              ...
              <p className="rounded-xl border border-dashed border-white/20 px-3 py-4 text-xs text-[var(--sidebar-muted)]">
                No activity yet.
              </p>
            )}
          </div>
